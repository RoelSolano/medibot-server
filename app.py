...
def url_absoluta(nombre_archivo):
    """Genera URL absoluta para un archivo de audio dinámico."""
    return f"{request.host_url}audio_dinamico/{nombre_archivo}"
...
def bienvenida():
    try:
        ...
        return jsonify({
            ...
            "audio_url": url_absoluta(nombre_audio)
        })
